...
<body>
    ...
    <thead>
    <tr>
        <th scope="col"><span style="margin-left: 12px;">#</span></th>
        <th scope="col"><span style="margin-left: 14px;">Game mode</span></th>
        <th scope="col"><span style="margin-left: 14px;">Due Date</span></th>
        <th scope="col"><span style="margin-left: 14px;">Status</span></th>
        <th scope="col" colspan="2"><span style="margin-left: 130px;">Play In</span></th>
    </tr>
    </thead>
    <tbody>
    <?php 
    ...
    foreach ($courses as $course):
        ...
        ?>
                <tr>
                    ...
                    <?php }
                    ?></td>
                    <td><span style="margin-left: 4px; color:blue;"><?= Html::a('Form Based', ['result', 'qid' => $questionset,'inid' => $interface,"assid"=>$assignmentid], ['class' => 'btn btn-default']) ?></span></td>
                    <td><span style="margin-left: 4px; color:blue;"><?= Html::a('Game Based', ['result', 'qid' => $questionset,'inid' => $interface, "assid"=>$assignmentid], ['class' => 'btn btn-default']) ?></span></td>
                </tr>
        <?php endforeach; ?>
    </tbody>
    </table>
