...
$courses= CoursesModerated::find()->where(['moderator_id' => $userId])->all();
$newCourses = Courses::find()
    ->where(['not in', 'id', array_column($courses, 'id')])
    ->all();
$previousRequested = ModeratorApprovalRequests::find()
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <p>
                            ...
                            <?= Html::a('<span class="glyphicon glyphicon-info-sign"></span> Send Request-->', ['moderator/createrequest', 'cid' => $code], ['class' => 'btn btn-default']) ?>
                            <?php endif; ?>
                        </p>
                    </div>
                </div>
