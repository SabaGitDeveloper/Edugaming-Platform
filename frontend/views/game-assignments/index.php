...
/** @var frontend\models\GameAssignmentsSearch $searchModel */
...
<div class="game-assignments-index">
    ...
    <p>
        <?= Html::a('Create Game Assignments', ['create','course_code' => $model->course_code,'topicID'=>$model->topicId], ['class' => 'btn btn-success']) ?>
    </p>
