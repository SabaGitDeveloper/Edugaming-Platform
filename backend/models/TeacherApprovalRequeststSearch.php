...
/**
 * TeacherApprovalRequeststSearch represents the model behind the search form of `backend\models\TeacherApprovalRequests`.
 */
class TeacherApprovalRequeststSearch extends TeacherApprovalRequests
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['status', 'date_sent', 'phoneNo', 'qualifications', 'experience', 'course_id', 'speciality'], 'safe'],
        ];
    }
